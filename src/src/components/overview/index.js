  ...
  return(
    <Container>
      <FeaturedPlaylists>
        ...
        <SelectLanguage language={linguageForTranslate}>
          ...
          <div> 
            <div onClick={() => {setLinguageForTranslate('portuguese')}}>
              <img src={BrazilFlag} alt="Brazil Flag" width="40px"/>
            </div>
            <div onClick={() => {setLinguageForTranslate('english')}}>
              <img src={EuaFlag} alt="EUA Flag" width="40px"/>
            </div>
          </div>
        ...
        <ScrollableContent>
          <div>
            <img src={Playlist1} alt='Playlist Content'/>
            <div>
              <h2>Only STARDUST</h2>
          ...
          <div>
            <img src={Playlist2} alt='Playlist Content'/>
            <div>
              <h2>Mike Vella</h2>
          ...
          <div>
            <img src={Playlist3} alt='Playlist Content'/>
            <div>
          ...
          <div>
            <img src={Playlist4} alt='Playlist Content'/>
            <div>
              <h2>Indie</h2>
          ...
          <div>
            <img src={Track4} alt='Playlist Content'/>
            <div>
              <h2>Rock Hits</h2>
      ...
      <ContentProfile>
       <ProfileView>
        ...
        <Tracks>
          ...
          <TracksContent>
          <div>
            <img src={Track1} alt='Playlist Content'/>
            <div>
              <h2>Mahara Bon</h2>
              <h5>Sexy In Paris</h5>
            </div> 
          ...
          <div>
            <img src={Track2} alt='Playlist Content'/>
            <div>
              <h2>Donna</h2>
              <h5>Pseudo-life</h5>
            </div> 
          ...
          <div>
            <img src={Track3} alt='Playlist Content'/>
            <div>
              <h2>Avven</h2>
              <h5>Magic</h5>
            </div> 
          ...
          <div>
            <img src={Track5} alt='Playlist Content'/>
            <div>
              <h2>Claudia Cany</h2>
              <h5>Remember</h5>
            </div> 
          ...
          <div>
            <img src={Track6} alt='Playlist Content'/>
            <div>
              <h2>Pacify</h2>
              <h5>Portrait</h5>
            </div> 
